...
class MSSQLServerMetadataFinder implements DatabaseMetadataFinder {
  ...
  private static final SqlQuery MS_SQL_SERVER_REFERENCED_TABLES_QUERY =
      new SqlQuery(
          "with\n"
  ...
  private static final SqlQuery MS_SQL_SERVER_COLUMNS_MAPPINGS_QUERY =
      new SqlQuery(
          "select\n"
  ...
  MSSQLServerMetadataFinder(DataSource dataSource) {
    ...
    this.mssqlServerReferencedTablesFinder =
        new BaseReferencedTablesFinder(dataSource, MS_SQL_SERVER_REFERENCED_TABLES_QUERY);
    this.mssqlServerColumnsMappingsFinder =
        new BaseColumnsMappingsFinder(dataSource, MS_SQL_SERVER_COLUMNS_MAPPINGS_QUERY);
  }
