...
public class OracleMetadataFinder implements DatabaseMetadataFinder {
  ...
  private static final SqlQuery COLUMNS_ORDER_QUERY =
      new SqlQuery(
  ...
  private static final SqlQuery REFERENCED_TABLES_QUERY =
      new SqlQuery(
          "select\n"
              + "       table_name,\n"
              + "       ref_table_name,\n"
  ...
  private static final SqlQuery COLUMNS_MAPPING_QUERY =
      new SqlQuery(
          "select\n"
              + "       c.owner              as table_schema,\n"
              + "       c.table_name,\n"
  ...
  private static final SqlQuery PRIMARY_KEY_QUERY =
      new SqlQuery(
          "select\n"
              + "       c.owner as table_schema,\n"
              + "       c.table_name,\n"
