...
class DatasetRowComparatorBuilder {
  ...
  static Comparator<DatasetRow> buildFrom(DatabaseMetadataFinder databaseMetadataFinder) {
    ComparatorOnTableDependencies comparatorOnTableDependencies =
        new ComparatorOnTableDependencies(databaseMetadataFinder);
    ComparatorOnPrimaryKey comparatorOnPrimaryKey =
        new ComparatorOnPrimaryKey(databaseMetadataFinder);
    ComparatorOnTableName comparatorOnTableName = new ComparatorOnTableName();
    return comparatorOnTableDependencies
        .thenComparing(comparatorOnPrimaryKey)
  ...
  private static class ComparatorOnPrimaryKey implements Comparator<DatasetRow> {
    ...
    private int compareIntPkValues(
        String primaryKeyColumn, DatasetRow datasetRow1, DatasetRow datasetRow2) {
      ...
      boolean integerPrimaryKey =
          pkValue1 instanceof Integer || pkValue1 instanceof Long || pkValue1 instanceof BigDecimal;
