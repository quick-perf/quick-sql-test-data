...
public class MSSQLServerTest {
  ...
  @RepeatedTest(9)
  public void should_sort_insert_statements_following_the_primary_key_values() {
  ...
  public void should_generate_an_insert_statement_with_a_timestamp_type() {
    ...
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "timestampCol DATETIME2")
            .create()
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_small_datetime_type() {
    // SMALLDATETIME is a timestamp type an accuracy of 1 minute
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "timestampCol SMALLDATETIME")
            .create()
            .insertValues("'2012-09-17 19:56:47.32'");
  ...
  public void should_generate_an_insert_statement_with_a_timestamp_with_time_zone_type() {
    ...
    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "col DATETIMEOFFSET")
            .create()
