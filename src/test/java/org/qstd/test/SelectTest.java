...
import static org.qstd.test.TestTable.TestTableAssert.*;
...
public class SelectTest extends H2Config {
  ...
  public void should_generate_working_insert_from_a_select_statement() {
    ...
    assertThat(playerTable)
        ...
        .row(1)
        .hasValues(2, "Antoine", "Griezmann");
  }

  @Test
  public void should_generate_an_insert_statement_from_a_select_containing_bind_parameters() {
    ...
    String select = " SELECT col1, col2, col3 FROM " + tableName + " WHERE col2=? AND col3=?";

    List<Object> parameterValues = Arrays.asList("val2", "val3");

    // WHEN
    QuickSqlTestData quickSqlTestData = QuickSqlTestData.buildFrom(DATA_SOURCE);
    String insertScript = quickSqlTestData.generateInsertScriptFor(select, parameterValues);
