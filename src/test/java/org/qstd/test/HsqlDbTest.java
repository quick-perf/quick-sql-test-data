...
public class HsqlDbTest {
  ...
  public void
    ...
    String colDescsAndConstraints =
        "id bigint" + ", firstName varchar(255)" + ", lastName varchar(255)";
    TestTable playerTable =
        TestTable.buildUniqueTable(DATA_SOURCE, "player", colDescsAndConstraints)
            .create()
            .insertValues("1, 'Paul', 'Pogba'");
  ...
  public void should_sort_insert_statements_following_a_composite_primary_key() {
    ...
    // WHEN
    QuickSqlTestData quickSqlTestData = QuickSqlTestData.buildFrom(DATA_SOURCE);
    List<String> insertStatements = quickSqlTestData.generateInsertListFor(select1, select2);
  ...
  public void
    ...
    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "timestampCol TIMESTAMP WITHOUT TIME ZONE")
            .create()
            .insertValues("'2012-09-17 19:56:47.32'");
  ...
  @Test
  public void should_generate_an_insert_statement_with_a_time_without_declared_time_zone_type() {

    // GIVEN
    TestTable playerTable =
        buildUniqueTable(DATA_SOURCE, "Table", "col TIME WITHOUT TIME ZONE")
            .create()
  ...
  public void should_generate_an_insert_statement_with_a_time_with_timezone_type() {
    ...
    assertThat(playerTable)
        ...
        .hasNumberOfRows(1)
        .row(0)
        .hasValues(OffsetTime.parse("23:59:59+08:00"));
  }
