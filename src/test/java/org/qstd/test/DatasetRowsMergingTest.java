...
public class DatasetRowsMergingTest extends H2Config {
  ...
  @Test
  public void should_merge_dataset_rows_if_columns_in_common_have_same_values() {
    ...
    String insertScript = quickSqlTestData.generateInsertScriptFor(select1, select2);
    ...
    assertThat(table)
        ...
        .hasNumberOfRows(1)
        .row(0)
        .hasValues("val1", "val2", "val3");
  }

  @Test
  public void should_merge_dataset_rows_in_case_of_joined_rows() {
    ...
    // WHEN
    QuickSqlTestData quickSqlTestData = QuickSqlTestData.buildFrom(DATA_SOURCE);
    String insertScript = quickSqlTestData.generateInsertScriptFor(playerSelect, sponsorSelect);
    ...
    assertThat(sponsorTable)
        .withScript(insertScript)
        .hasNumberOfRows(1)
        .row(0)
        .hasValues(1, "Sponsor name", "France");
  }
