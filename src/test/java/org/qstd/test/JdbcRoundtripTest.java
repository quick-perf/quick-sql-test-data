...
public class JdbcRoundtripTest extends H2Config {
  ...
  @Test
  public void should_limit_jdbc_roundtrips() {
    ...
    insertScript = quickSqlTestData.generateInsertScriptFor(t2Select, t3Select);
  }
  ...
  public void check_inserted_data() {
    ...
    assertThat(t1Table).withScript(insertScript).hasNumberOfRows(2);
    assertThat(t2Table).withScript(insertScript).hasNumberOfRows(2);
    assertThat(t3Table).withScript(insertScript).hasNumberOfRows(2);
  }
}
