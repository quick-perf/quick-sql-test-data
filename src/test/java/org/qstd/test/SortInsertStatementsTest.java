...
public class SortInsertStatementsTest extends H2Config {
  ...
  @RepeatedTest(9)
  public void should_sort_insert_statements_following_table_names_if_independent_tables() {

    TestTable testTable1 =
        buildUniqueTable(DATA_SOURCE, "TABLE_1", "col varchar(20)")
            .create()
            .insertValues("'value_col_tab1'");

    TestTable testTable2 =
        buildUniqueTable(DATA_SOURCE, "TABLE_2", "col varchar(20)")
            .create()
